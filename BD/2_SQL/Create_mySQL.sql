...
CREATE TABLE SEMESTRE (
	...
	nom_semestre VARCHAR(10), -- nom automatique S1, S2, S3, S4 en fonction du nombre de semestres, nombre que choisit le professeur responsable de la formation sur l'interface java
	nom_formation VARCHAR(30),
	annee_formation INTEGER,
...
CREATE TABLE NOTES (
	...
	id_groupe INTEGER,
	id_enseignement INTEGER,
	libelle_interrogation VARCHAR(50),
